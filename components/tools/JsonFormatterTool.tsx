        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">JSON Formatter</h1>
                <p className="text-sm text-gray-600">Format, validate and minify JSON data</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="mt-8 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Format & Beautify</h4>
                <p className="text-sm text-gray-600">Pretty-print JSON with customizable indentation (2 or 4 spaces) for better readability.</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Validate & Verify</h4>
                <p className="text-sm text-gray-600">Instantly check if your JSON is valid and get detailed error messages for debugging.</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Minify & Compress</h4>
                <p className="text-sm text-gray-600">Remove unnecessary whitespace and reduce file size for production use.</p>
              </div>
            </div>
          </CardContent>
        </Card>
